...
export default function SyncedGrindTimer({ groupId }: { groupId: string }) {
  ...
  const loadGroup = useCallback(async () => {
    ...
    if (data.created_by !== user.id) { router.replace(`/grind/${groupId}`); return; }
    setGroup(data);
