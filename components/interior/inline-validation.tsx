...
export function useInlineValidation({
  ...
  useEffect(() => {
    ...
    const resolved: ValidationStatus =
      value.length > 0 ? "valid" : "idle";
...
export function InlineValidation({
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <label
        htmlFor={fieldId}
        className="block text-[13px] font-medium text-stone-800"
      >
        {label}
      </label>
            ...
            ${
              invalid
                ...
                : `
                  ...
                  bg-white/25
                  backdrop-blur-2xl
                  shadow-[inset_0_1px_2px_rgba(255,255,255,0.7),0_2px_10px_rgba(0,0,0,0.04)]
                  focus:border-white/80
                  focus:bg-white/35
                  focus:shadow-[inset_0_1px_2px_rgba(255,255,255,0.8),0_4px_20px_rgba(0,0,0,0.06)]
                `
            }
          `}
        />
